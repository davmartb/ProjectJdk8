...
public final class HexSupport {
	...
	protected static final Logger logger = Logger.getLogger(HexSupport.class);
    ...
    public static byte[] toBytesFromHex(String hex) {
    	...
    	try {
    		...
    		Utilidades.escribirLogException(e, logger, HexSupport.class.getName(), "toBytesFromHex");
		}
        return rc;
    }
    ...
    public static String toHexFromBytes(byte[] bytes) {
    	...
    	try {
	        ...
	        strResult = rc.toString();
    	} catch (Exception e) {
    		Utilidades.escribirLogException(e, logger, HexSupport.class.getName(), "toHexFromBytes");
		}
        return strResult;
    }
    ...
    public static String toHexFromInt(int value, boolean trim) {
    	...
    	try {
    		...
    		Utilidades.escribirLogException(e, logger, HexSupport.class.getName(), "toHexFromInt");
		}
        return strResult;
    }
    ...
    public static String byteArrayToHexString(byte[] array) {
    	...
    	try {
    		...
    		Utilidades.escribirLogException(e, logger, HexSupport.class.getName(), "byteArrayToHexString");
		}
        return strResult;    
      }
